...
Route::group(
    ...
    function () {
        ...
        Route::post('admin/store/rave-payment-settings', 'SiteManagementController@storeRaveSettings');
...
Route::group(
    ...
    function () {
        ...
        Route::post('freelancer/store-skills-specialization', 'FreelancerController@storeSkillsSpecialization');
        ...
        Route::get('freelancer/get-freelancer-certifications', 'FreelancerController@getFreelancerCertifications');
        ...
        Route::get('freelancer/skillsSpecialization', 'FreelancerController@skillsSpecialization')->name('skillsSpecialization');
...
Route::post('get-freelancer-certifications', 'PublicController@getFreelancerCertifications');
