                    ...
                    <?php if($role === 'admin'): ?>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><hr><a href="<?php echo e(route('citations')); ?>"><?php echo e(trans('lang.writer_cits')); ?></a></li>
                                ...
                                <li><hr><a href="<?php echo e(route('deliveryTime')); ?>"><?php echo e(trans('lang.delivery_time')); ?></a></li>
                                <li><hr><a href="<?php echo e(route('ResponseTime')); ?>"><?php echo e(trans('lang.response_time')); ?></a></li>
                            </ul>
                        </li>
                    <?php endif; ?>
