                    ...
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            ...
                            <div class="wt-joblocation wt-tabsinfo">
                                ...
                                <div class="wt-formtheme wt-userform wt-userformvtwo">
                                    <fieldset>
                                        <div class="form-group form-group-half wt-formwithlabel">
                                            <span class="wt-select">
                                                <?php echo Form::select('location', $locations, null, array('class' => '', 'placeholder' => trans('lang.ph_select_location'))); ?>

                                            </span>
                                        </div>
                                        <div class="form-group form-group-half wt-formwithlabel">
                                            <?php echo Form::text( 'address', null, ['class' =>'form-control', 'placeholder' => trans('lang.ph_your_address')] ); ?>
                                        ...
                                        <div class="form-group form-group-half wt-formwithlabel">
                                            <?php echo Form::text( 'longitude', null, ['class' =>'form-control', 'placeholder' => trans('lang.ph_enter_logitude')]); ?>

                                        </div>
                                        <div class="form-group form-group-half wt-formwithlabel">
                                            <?php echo Form::text( 'latitude', null, ['class' =>'form-control', 'placeholder' => trans('lang.ph_enter_latitude')]); ?>
                            ...
                            <div class="wt-featuredholder wt-tabsinfo">
                                <div class="wt-tabscontenttitle">
                                    <h2><?php echo e(trans('lang.your_budget')); ?></h2>
                                </div>
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <fieldset>
                                        <div class="form-group form-group-half wt-formwithlabel">
                                            <span class="wt-select">
                                                <?php echo Form::select('currency', $currency, e($existing_currency), array('class'=>'','placeholder'=>trans('lang.ph_select_currency'))); ?>
