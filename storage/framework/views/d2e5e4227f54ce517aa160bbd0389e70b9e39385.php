            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                    <div class="wt-dashboardbox wt-dashboardtabsholder">
                        <?php if(file_exists(resource_path('views/extend/back-end/employer/payouts/tabs.blade.php'))): ?>
                            <?php echo $__env->make('extend.back-end.employer.payouts.tabs', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php else: ?>
                            <?php echo $__env->make('back-end.employer.payouts.tabs', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php endif; ?>
                        <div class="wt-tabscontent tab-content">
                            ...
                            <div class="wt-settingscontent">
                                <div class="wt-description">
                                    <p><?php echo e(trans('lang.emp_payout_settings_note')); ?></p>
                                </div>
                                <form class="wt-formtheme wt-payout-settings la-payout-settings" @submit.prevent="submitPayoutsDetail(<?php echo e(Auth::user()->id); ?>)" id="profile_payout_detail">
                                    <?php if( !empty($payrols) ): ?>
                                        <?php $__currentLoopData = $payrols; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay_key	=> $payrol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                if ( $payrol['id'] === 'bacs' ) {
                                                    $vue_display = 'show_bank_fields';
                                                } elseif ($payrol['id'] === 'rave') {
                                                    $vue_display = 'show_rave_fields';
                                                } else {
                                                    $vue_display = 'show_paypal_fields';
                                                }
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="fields-wrapper wt-haslayout" v-if="<?php echo e($vue_display); ?>">
                                                        <div class="wt-description">
                                                            ...
                                                            <?php elseif($payrol['id'] == 'rave'): ?>
                                                                <p><?php echo e(trans('lang.rave_payout_id_text')); ?> <a target="_blank" href="https://www.flutterwave.com/"> <?php echo e(trans('lang.rave')); ?> </a> | <a target="_blank" href="https://rave.flutterwave.com/signup?referrals=RV34552"><?php echo e(trans('lang.payout_id_create_acc')); ?></a></p>
