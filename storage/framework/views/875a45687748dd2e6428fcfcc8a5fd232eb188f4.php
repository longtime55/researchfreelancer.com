                ...
                <div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
                    ...
                    <div class="wt-tabscontent tab-content">
                        ...
                        <div class="wt-securityhold tab-pane la-payment-setting" id="wt-payment">
                            ...
                            <?php endif; ?>
                            <?php if(file_exists(resource_path('views/extend/back-end/admin/settings/payment/rave-settings.blade.php'))): ?>
                                <?php echo $__env->make('extend.back-end.admin.settings.payment.rave-settings', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('back-end.admin.settings.payment.rave-settings', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php endif; ?>
