...
class Helper extends Model
{
    ...
    public static function getBannerImage($image, $path = '')
    {
        ...
        } elseif (empty($image) && isset($_GET['type']) && $_GET['type'] == 'project') {
    ...
    public static function getSocialData()
    {
        $social = array(
            ...
            'pinterest' => array(
                'title' => trans('lang.social_icons.pint'),
                'color' => '#e60023',
                'icon' => 'fa-pinterest',
            ),
            'youtube' => array(
    ...
    public static function getHomeSection($type)
    {
        ...
        $detail_sec_title = !empty($section_settings[0]['detail_sec_title']) ? $section_settings[0]['detail_sec_title'] : trans('lang.just_give_us');
        $detail_sec_subtitle = !empty($section_settings[0]['detail_sec_subtitle']) ? $section_settings[0]['detail_sec_subtitle'] : trans('lang.just_give_us_details');
        ...
        if ($type == 'detail_sec_title') {
            return $detail_sec_title;
        }
        if ($type == 'detail_sec_subtitle') {
            return $detail_sec_subtitle;
        }
    ...
    public static function getPayoutsList()
    {
        $list = array(
            ...
            'rave' => array(
                'id'        => 'rave',
                'title'        => trans('lang.rave'),
                'img_url'    => url('/images/payouts/rave.png'),
                'status'    => 'enable',
                'fields'    => array(
                    'rave_email' => array(
                        'type'            => 'text',
                        'classes'        => '',
                        'required'        => true,
                        'placeholder'    => trans('lang.add_rave_email_address'),
                        'message'        => trans('lang.rave_email_address_is_required'),
                    )
                )
            ),
            'bacs' => array(
