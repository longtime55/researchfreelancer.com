...
Vue.component('freelancer_certification', require('./components/ProfileCertificationComponent.vue').default);
...
Vue.component('certification', require('./components/FreelancerCertificationComponent.vue').default);
...
if (document.getElementById("cit-list")) {
    const vmcitList = new Vue({
        el: '#cit-list',
        mounted: function () {
            if (document.getElementsByClassName("flash_msg") != null) {
                flashVue.$emit('showFlashMessage');
        ...
        methods: {
            ...
            selectAll: function () {
                this.is_show = !this.is_show;
                jQuery("#wt-cits").change(function () {
                    jQuery("input:checkbox").prop('checked', jQuery(this).prop("checked"));
                });
            },
            selectRecord: function () {
            ...
            deleteChecked: function (msg, text) {
                ...
                this.$swal({
                    ...
                    var self = this;
                    if (result.value) {
                        axios.post(APP_URL + '/admin/delete-checked-cits', {
                            ids: deleteIDs
                        })
                            .then(function (response) {
                                if (response.data.type == "success") {
...
if (document.getElementById("user_profile")) {
    const freelancerProfile = new Vue({
        ...
        methods: {
            ...
            submitSkillsSpecialization: function submitSkillsSpecialization() {
                var self = this;
                var skills_special = document.getElementById('skills_specialization');
            ...
            getSitePaymentOptions: function () {
                ...
                axios.get(APP_URL + '/admin/get/site-payment-option')
                    .then(function (response) {
                        ...
                        if (response.data.enable_test == 'true') {
...
if (document.getElementById("packages")) {
    const packages = new Vue({
        ...
        methods: {
            ...
            getRaveForm: function () {
                this.$refs.myRaveModalRef.show()
            },
            submitRaveFrom: function () {
                this.loading = true;
                let rave_payment = document.getElementById('rave-payment-form');
                let data = new FormData(rave_payment);
                var self = this;
            ...
            getUserPayoutSettings: function() {
                ...
                .then(function (response) {
                    if (response.data.type == 'success') {
                        ...
                        } else if (response.data.payouts.type == 'rave') {
                            self.show_rave_fields = true;
                        }
                    } else {
