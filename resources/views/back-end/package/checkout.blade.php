                    ...
                    <div class="wt-dashboardbox">
                         ...
                         <div class="sj-checkoutjournal">
                            ...
                            @php
                                ...
                                session()->put(['product_price' => e(Helper::convertCurrency($package->cost, $from_currency, $to_currency))]);
                              ...
                              <table class="sj-checkouttable">
                                   ...
                                   <tbody>
                                        <tr>
                                             ...
                                             <td>{{ $symbol['symbol'] }}{{{ Helper::convertCurrency($package->cost, $from_currency, $to_currency) }}}</td>
                                        </tr>
                                        <tr>
                         ...
                         <div class="sj-checkpaymentmethod">
                              ...
                              <ul class="sj-paymentmethod">
                                   @foreach ($payment_gateway as $key => $gateway)
                                        <li>
                                        @if ($gateway == "rave")
                                            <form method="POST" role="form" id="rave-form" action="{{ route('paywithrave') }}">
                                                {{ csrf_field() }}
                                                {!! Form::hidden( 'amount', e(Helper::convertCurrency($package->cost, $from_currency, $to_currency)) ) !!}
                                                {!! Form::hidden( 'phonenumber', e($phonenumber) ) !!}
                                                {!! Form::hidden( 'currency', e($to_currency) ) !!}
                                                ...
                                                <a href="javascript:{}" onclick="document.getElementById('rave-form').submit();return false;">
                                                    <i class="fa fa-credit-card"></i>
                                                    <span>
                                                        <em>Pay {{ $symbol['symbol'] }}{{ Helper::convertCurrency($package->cost, $from_currency, $to_currency) }} via</em>
                                        ...
                                        @elseif ($gateway == "stripe")
                                            <a href="javascript:void(0);" v-on:click.prevent="getStripeForm">
                              ...
                              <form class="wt-formtheme wt-form-paycard" method="POST" id="stripe-payment-form" role="form" action="" @submit.prevent='submitStripeFrom'>
                                   ...
                                   <fieldset>
                                        ...
                                        <div class="form-group wt-btnarea">
                                             <input type="submit" name="button" class="wt-btn" value="Pay {{ $symbol['symbol'] }}{{ Helper::convertCurrency($package->cost, $from_currency, $to_currency) }}">
                                        </div>
                                   </fieldset>
                              </form>
                         </div>
