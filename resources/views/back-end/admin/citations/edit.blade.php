                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 float-left">
                    <div class="wt-dashboardbox">
                        <div class="wt-dashboardboxtitle">
                            <h2>{{{ trans('lang.edit_cit') }}}</h2>
                        </div>
                        <div class="wt-dashboardboxcontent">
                            {!! Form::open(['url' => url('admin/citations/update-cits/'.$cits->id.''),
                                'class' =>'wt-formtheme wt-formprojectinfo wt-formcategory', 'id' => 'citations'] )
                            !!}
                                <fieldset>
                                    <div class="form-group">
                                        {!! Form::text( 'citation_title', e($cits['title']), ['class' =>'form-control'] ) !!}
                                        <span class="form-group-description">{{{ trans('lang.desc') }}}</span>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::textarea( 'citation_abstract', e($cits['abstract']), ['class' =>'form-control',
