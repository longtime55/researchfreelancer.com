...
<div class="wt-divtheme wt-userform wt-userformvtwo">
    <fieldset>
        ...
        <div class="form-group form-group-half">
            {!! Form::tel( 'phone_number', e(Auth::user()->phone_number), ['id' =>'fr_pn', 'class' =>'form-control'] ) !!}
            {!! Form::hidden( 'dialcode', '', ['id' =>'fr_dialcode'] ) !!}
        </div>
        <div class="form-group form-group-half">
...
@push('scripts')
    ...
    <script>
        ...
        function phoneFunction() {
            var input = document.querySelector("#fr_pn"),
            dialcode = document.querySelector("#fr_dialcode"),
            submit = document.querySelector("#submit-freelancer-profile"),
